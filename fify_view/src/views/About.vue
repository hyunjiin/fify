...
<div>
    ...
    <div id="template">
        ...
        <div style = "font-weight:900; font-size:2rem; margin-bottom:70px; padding-top:-10px;">저시력자를 위한 제품 안내 서비스</div>


        <span style = "font-weight:900; font-size:1.5rem; box-shadow: inset 0 -10px #3767FF; line-height:21px; margin:0"> 검색 기능</span>
        ...
        <span style = "font-weight:900; font-size:1.5rem; box-shadow: inset 0 -10px #3767FF; line-height:21px; margin:0">확인 기능</span>
